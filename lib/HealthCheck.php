...
class HealthCheck
{
  ...
  private function setRestConfig($config)
  {
  ...
  private function verifyByKeys($configArr, $keysArr)
  {
    foreach ($keysArr as $key ) {
      if (!array_key_exists($key, $configArr)) {
        die('Error!, No hay llave valida para la configuracion');
      }
    }
  }

  private function setLegacyConfig($config)
  {
